...
export const LAB_COMPONENTS: Record<string, LabComponent> = {
  ...
  "resistor": {
    ...
    color: "#D97706",
    pins: [
      { id: "pin-1", label: "1", x: 20, y: 60 },
      { id: "pin-2", label: "2", x: 70, y: 60 },
    ],
  },
  "buzzer": {
    id: "buzzer",
    ...
    color: "#1F2937",
    pins: [
      { id: "pos", label: "+", x: 25, y: 80 },
      { id: "neg", label: "-", x: 70, y: 80 },
    ],
  },
  "push-button": {
    id: "push-button",
    ...
    color: "#4B5563",
    pins: [
      { id: "pin-1a", label: "1A", x: 25, y: 80 },
      { id: "pin-1b", label: "1B", x: 65, y: 80 },
    ],
  },
  "l298n": {
    id: "l298n",
  ...
  "potentiometer": {
    ...
    color: "#059669",
    pins: [
      { id: "vcc", label: "VCC", x: 20, y: 80 },
      { id: "sig", label: "WIPER", x: 50, y: 80 },
      { id: "gnd", label: "GND", x: 80, y: 80 },
    ],
  },
  "dht11": {
    id: "dht11",
  ...
  "rgb-led": {
    ...
    color: "#EC4899",
    pins: [
      { id: "red", label: "R", x: 15, y: 80 },
      { id: "gnd", label: "GND", x: 35, y: 80 },
      { id: "green", label: "G", x: 55, y: 80 },
      { id: "blue", label: "B", x: 75, y: 80 },
    ],
  },
  "photoresistor": {
    id: "photoresistor",
    ...
    color: "#F59E0B",
    pins: [
      { id: "pin-1", label: "1", x: 25, y: 80 },
      { id: "pin-2", label: "2", x: 65, y: 80 },
    ],
  },
  "servo-mg996r": {
    id: "servo-mg996r",
  ...
  "tp4056": {
    ...
    color: "#1D4ED8",
    pins: [
      { id: "usb-in", label: "USB-C IN", x: 10, y: 40 },
      { id: "in-plus", label: "IN +", x: 25, y: 10 },
      { id: "in-minus", label: "IN -", x: 25, y: 70 },
      { id: "bat-plus", label: "BAT +", x: 85, y: 10 },
      { id: "bat-minus", label: "BAT -", x: 85, y: 70 },
      { id: "out-plus", label: "OUT +", x: 60, y: 10 },
      { id: "out-minus", label: "OUT -", x: 60, y: 70 },
    ],
  },
  "lipo-battery": {
    id: "lipo-battery",
  ...
  "level-shifter": {
    ...
    color: "#374151",
    pins: [
      { id: "lv", label: "LV (3.3V)", x: 15, y: 15 },
      { id: "lv1", label: "LV1", x: 35, y: 15 },
      { id: "lv2", label: "LV2", x: 55, y: 15 },
      { id: "gnd-l", label: "GND", x: 75, y: 15 },
      { id: "hv", label: "HV (5V)", x: 15, y: 65 },
      { id: "hv1", label: "HV1", x: 35, y: 65 },
      { id: "hv2", label: "HV2", x: 55, y: 65 },
      { id: "gnd-h", label: "GND", x: 75, y: 65 },
    ],
  },
  "jumper-m-m": {
    id: "jumper-m-m",
    ...
    color: "#4B5563",
    pins: [
      { id: "pin-a", label: "TIP A", x: 20, y: 65 },
      { id: "pin-b", label: "TIP B", x: 75, y: 65 },
    ],
  },
  "pir-sensor": {
    id: "pir-sensor",
    ...
    pins: [
      { id: "vcc", label: "VCC", x: 15, y: 40 },
      { id: "out", label: "OUT", x: 40, y: 40 },
      { id: "gnd", label: "GND", x: 65, y: 40 },
    ],
  },
  "gas-sensor": {
    id: "gas-sensor",
    ...
    color: "#78350F",
    pins: [
      { id: "vcc", label: "VCC", x: 15, y: 50 },
      { id: "gnd", label: "GND", x: 35, y: 50 },
      { id: "ao", label: "AOUT", x: 55, y: 50 },
      { id: "do", label: "DOUT", x: 70, y: 30 },
    ],
  },
  "soil-moisture": {
    id: "soil-moisture",
    ...
    color: "#4D7C0F",
    pins: [
      { id: "vcc", label: "VCC", x: 15, y: 70 },
      { id: "gnd", label: "GND", x: 35, y: 70 },
      { id: "sig", label: "SIG", x: 55, y: 70 },
    ],
  },
  "rfid-module": {
    id: "rfid-module",
    ...
    color: "#1E3A8A",
    pins: [
      { id: "vcc", label: "3.3V", x: 10, y: 50 },
      { id: "gnd", label: "GND", x: 25, y: 50 },
      { id: "sda", label: "SDA", x: 40, y: 50 },
      { id: "sck", label: "SCK", x: 55, y: 50 },
      { id: "mosi", label: "MOSI", x: 70, y: 50 },
      { id: "miso", label: "MISO", x: 80, y: 30 },
    ],
  },
  "gps-module": {
    id: "gps-module",
    ...
    pins: [
      { id: "vcc", label: "VCC", x: 15, y: 50 },
      { id: "rx", label: "RX", x: 35, y: 50 },
      { id: "tx", label: "TX", x: 55, y: 50 },
      { id: "gnd", label: "GND", x: 70, y: 30 },
    ],
  },
  "stepper-motor": {
    id: "stepper-motor",
    ...
    color: "#6B7280",
    pins: [
      { id: "vcc", label: "5V", x: 15, y: 60 },
      { id: "in1", label: "IN1", x: 30, y: 60 },
      { id: "in2", label: "IN2", x: 45, y: 60 },
      { id: "in3", label: "IN3", x: 60, y: 60 },
      { id: "in4", label: "IN4", x: 75, y: 60 },
    ],
  },
  "relay-module": {
    id: "relay-module",
    name: "5V Active Relay",
    icon: "⚡",
    width: 80,
    height: 50,
    color: "#065F46",
    pins: [
      ...
      { id: "in", label: "IN", x: 55, y: 40 },
      { id: "com", label: "COM", x: 15, y: 10 },
      { id: "no", label: "NO", x: 45, y: 10 },
      { id: "nc", label: "NC", x: 65, y: 10 },
    ],
  },
  "oled-display": {
    id: "oled-display",
    name: "0.96\" I2C OLED Screen",
    icon: "📺",
    width: 100,
    height: 60,
    color: "#1E293B",
    pins: [
      { id: "gnd", label: "GND", x: 20, y: 50 },
      { id: "vcc", label: "VCC", x: 40, y: 50 },
      { id: "scl", label: "SCL", x: 60, y: 50 },
      { id: "sda", label: "SDA", x: 80, y: 50 },
    ],
  },
  "keypad-module": {
    id: "keypad-module",
    ...
    color: "#374151",
    pins: [
      { id: "r1", label: "R1", x: 15, y: 90 },
      { id: "r2", label: "R2", x: 27, y: 90 },
      { id: "r3", label: "R3", x: 39, y: 90 },
      { id: "r4", label: "R4", x: 51, y: 90 },
      { id: "c1", label: "C1", x: 63, y: 90 },
      { id: "c2", label: "C2", x: 75, y: 90 },
      { id: "c3", label: "C3", x: 87, y: 90 },
      { id: "c4", label: "C4", x: 99, y: 90 },
    ],
  },
  "joystick-module": {
    id: "joystick-module",
    name: "Analog Dual Axis Joystick",
    icon: "🕹️",
    width: 90,
    height: 80,
    color: "#111827",
    pins: [
      ...
      { id: "vcc", label: "+5V", x: 30, y: 70 },
      { id: "vrx", label: "VRx", x: 45, y: 70 },
      { id: "vry", label: "VRy", x: 60, y: 70 },
      { id: "sw", label: "SW", x: 75, y: 70 },
    ],
  },
  "bluetooth-module": {
    id: "bluetooth-module",
    ...
    pins: [
      { id: "vcc", label: "VCC", x: 15, y: 40 },
      { id: "gnd", label: "GND", x: 30, y: 40 },
      { id: "tx", label: "TX", x: 45, y: 40 },
      { id: "rx", label: "RX", x: 60, y: 40 },
    ],
  },
  "wifi-module": {
    id: "wifi-module",
    name: "ESP8266 ESP-01 WiFi",
    icon: "📶",
    width: 60,
    height: 50,
    color: "#065F46",
    pins: [
      { id: "vcc", label: "VCC", x: 10, y: 40 },
      { id: "gnd", label: "GND", x: 22, y: 40 },
      { id: "tx", label: "TXD", x: 34, y: 40 },
      { id: "rx", label: "RXD", x: 46, y: 40 },
    ],
  },
  "camera-module": {
    id: "camera-module",
    ...
    color: "#0F172A",
    pins: [
      { id: "vcc", label: "3.3V", x: 15, y: 70 },
      { id: "gnd", label: "GND", x: 30, y: 70 },
      { id: "scl", label: "SIOC", x: 45, y: 70 },
      { id: "sda", label: "SIOD", x: 60, y: 70 },
      { id: "vsync", label: "VSYNC", x: 75, y: 70 },
    ],
  },
  "obj-box": {
    id: "obj-box",
    name: "Obstacle Box (Testing)",
    icon: "📦",
    width: 80,
    height: 85,
    color: "#B45309",
